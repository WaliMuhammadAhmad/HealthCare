...
export function UserProfileForm() {
  ...
  return (
    <Tabs defaultValue="profile" className="w-full">
      ...
      <TabsContent value="profile">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="gender" name="gender" value={profileData.gender} onChange={handleProfileChange} />
                </div>
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Actions that will affect your account access and data.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between rounded-lg border p-4">
              ...
              <Button variant="outline" onClick={() => setDeactivateAccountDialog(true)}>
                Deactivate
              </Button>
            </div>
            ...
            <div className="flex items-center justify-between rounded-lg border p-4">
              ...
              <Button variant="destructive" onClick={() => setDeleteAccountDialog(true)}>
                Delete
              </Button>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="emailAppointmentChanges">Appointment Changes</Label>
                      <p className="text-sm text-muted-foreground">
                        Receive emails about appointment cancellations or reschedules
                      </p>
                    </div>
                    <Switch
                      id="emailAppointmentChanges"
                      checked={notificationSettings.emailAppointmentChanges}
                      onCheckedChange={(checked) => handleNotificationChange("emailAppointmentChanges", checked)}
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="emailMedicalUpdates">Medical Updates</Label>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange("emailMedicalUpdates", checked)}
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="smsAppointmentReminders">Appointment Reminders</Label>
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange("smsAppointmentReminders", checked)}
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="smsAppointmentChanges">Appointment Changes</Label>
                      <p className="text-sm text-muted-foreground">
                        Receive SMS about appointment cancellations or reschedules
                      </p>
                    </div>
                    <Switch
                      id="smsAppointmentChanges"
                      checked={notificationSettings.smsAppointmentChanges}
                      onCheckedChange={(checked) => handleNotificationChange("smsAppointmentChanges", checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange("smsMedicalUpdates", checked)}
                    />
                  </div>
                </div>
              </div>
      ...
      <Dialog open={deleteAccountDialog} onOpenChange={setDeleteAccountDialog}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleRequestAccountDeletion} disabled={!accountActionReason}>
              Delete My Account
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={deactivateAccountDialog} onOpenChange={setDeactivateAccountDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle className="flex items-center">
              <AlertCircle className="h-5 w-5 mr-2 text-destructive" />
          ...
          <div className="py-4">
            <div className="space-y-2">
              <Label htmlFor="deactivateReason">Please tell us why you're deactivating</Label>
              <Textarea
                id="deactivateReason"
                placeholder="Your feedback helps us improve our services..."
                value={accountActionReason}
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setDeactivateAccountDialog(false)}>
              Cancel
            </Button>
            <Button variant="destructive" onClick={handleRequestAccountDeactivation} disabled={!accountActionReason}>
              Deactivate Account
            </Button>
          </DialogFooter>
        </DialogContent>
